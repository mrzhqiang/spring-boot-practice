...
(function () {
  var Byte, Client, Frame, Stomp, hasProp = {}.hasOwnProperty, slice = [].slice;
  ...
  Frame = (function () {
    ...
    unmarshallSingle = function (data, escapeHeaderValues) {
      var body, chr, command, divider, headerLines, headers, i, idx, j, k, len, len1, line, ref,
          ref1, ref2, start, trim;
      ...
      if (headers['content-length']) {
        ...
        chr = null;
        for (i = k = ref1 = start, ref2 = data.length; ref1 <= ref2 ? k < ref2 : k > ref2; i = ref1
        <= ref2 ? ++k : --k) {
          chr = data.charAt(i);
          if (chr === Byte.NULL) {
            break;
    ...
    Frame.unmarshall = function (datas, escapeHeaderValues) {
      ...
      if (last_frame
          === Byte.LF
          || (last_frame.search(RegExp("" + Byte.NULL + Byte.LF + "*$")))
          !== -1) {
  ...
  Client = (function () {
    ...
    Client.prototype.debug = function (message) {
      var ref;
      return typeof window !== "undefined" && window !== null ? (ref = window.console)
      != null ? ref.log(message) : void 0 : void 0;
    };
    ...
    Client.prototype._connect = function () {
      ...
      this.ws.onmessage = (function (_this) {
        return function (evt) {
          var arr, client, data, frame, j, len1, messageID, onreceive, ref, subscription,
              unmarshalledData;
          data = typeof ArrayBuffer
          !== 'undefined'
          && evt.data
          instanceof ArrayBuffer ? (arr = new Uint8Array(evt.data), typeof _this.debug
          === "function" ? _this.debug("--- got data length: "
              + arr.length) : void 0, UTF8ArrayToStr(arr)) : evt.data;
    ...
    Client.prototype._schedule_reconnect = function () {
      if (this.reconnect_delay > 0) {
        ...
        return this._reconnector = setTimeout((function (_this) {
          return function () {
            if (_this.connected) {
              return typeof _this.debug
              === "function" ? _this.debug('STOMP: already connected') : void 0;
            } else {
              if (typeof _this.debug === "function") {
    ...
    Client.prototype.disconnect = function (disconnectCallback, headers) {
      ...
      if (this.connected) {
        ...
        try {
          ...
          error = error1;
          return typeof this.debug
          === "function" ? this.debug('Ignoring error during disconnect', error) : void 0;
        }
      }
    };
    ...
    Client.prototype.subscribe = function (destination, callback, headers) {
      ...
      client = this;
      return {
        id: headers.id, unsubscribe: function (hdrs) {
